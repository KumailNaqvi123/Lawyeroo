...
class EditLawyerProfilePage extends StatefulWidget {
  ...
  required this.token,
  required this.onUpdateComplete, required specializations, // Added callback
});

  @override
  _EditLawyerProfilePageState createState() => _EditLawyerProfilePageState();
}

class _EditLawyerProfilePageState extends State<EditLawyerProfilePage> {
...
void _showSpecializationsDialog() {
  ...
  void _saveSpecializations() {
  // Logic to save Specializations
  print('Specializations saved: $lawyerSpecializations');
}
 ...
 @override
  void initState() {
    ...
    _feesController = TextEditingController(text: widget.userData['fees'].toString());
    // Initialize Specializations
    initializespecializations();
  }

   void initializespecializations() {
  // Assuming Specializations come as a JSON-encoded string from userData
var specializationsData = GlobalData().userData['specializations'];
var specializationsStr = specializationsData is List ? jsonEncode(specializationsData) : specializationsData ?? '';
...
void _saveProfile() async {
  ...
  var url = Uri.parse('${GlobalData().baseUrl}/api/lawyers/update-lawyer/${GlobalData().userData['id']}');
  ...
  List<String> selectedSpecializations = lawyerSpecializations.entries
      ...
      .map((entry) => entry.key)
      .toList();
  // Convert the list of specializations to JSON array and set it in the request fields
